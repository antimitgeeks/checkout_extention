...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/extension.mjs
  ...
  function Extension() {
    ...
    const customerId = (_d = (_c = (_b = (_a = buyerIdentity == null ? void 0 : buyerIdentity.customer) == null ? void 0 : _a.current) == null ? void 0 : _b.id) == null ? void 0 : _c.split("/")) == null ? void 0 : _d.pop();
    const productId = "gid://shopify/Product/9436726264091";
    const SERVER_URL = scriptUrl.split("/").slice(0, 3).join("/").split(".com")[0] + ".com";
    console.log("Customer Id :", customerId);
    console.log("Product Id :", productId);
    console.log("Server Url :", SERVER_URL);
    const [showMore, setShowMore] = (0, import_react21.useState)(true);
    const [selectedNpos, setSelectedNpos] = (0, import_react21.useState)([]);
    const [showWarning, setShowWarning] = (0, import_react21.useState)(false);
    const [showNpo, setShowNpos] = (0, import_react21.useState)(false);
    const [previousData, setPreviousData] = (0, import_react21.useState)([]);
    const [previousLoading, setPreviousLoading] = (0, import_react21.useState)(true);
    const [metaFields, setMetaFields] = (0, import_react21.useState)();
    ...
    (0, import_react21.useEffect)(() => {
      ...
      ).then((_0) => __async(this, [_0], function* ({ data, errors }) {
        var _a2;
        if (errors) {
          console.log("Product MetaFelids fetch Error : ", errors);
        }
        const metaFieldsDetails = (_a2 = data == null ? void 0 : data.product) == null ? void 0 : _a2.metafields;
        if (metaFieldsDetails) {
          let filedArray = metaFieldsDetails.filter((metaFieldsDetail) => metaFieldsDetail == null ? void 0 : metaFieldsDetail.value).flatMap((metaFieldsDetail) => metaFieldsDetail.value.split(",").map((item) => item.trim()));
          filedArray = (filedArray == null ? void 0 : filedArray.includes("emptyNpos")) ? [] : filedArray;
          ...
          yield fetch(`${SERVER_URL}/npo-valid`, config).then((response) => response.json()).then((result) => {
            console.log("Valid NPOS :", result);
            setMetaFields(result.npos);
          }).catch((error) => {
            console.log("Error In Valid NPOS :", error);
          });
        }
      })).catch((error) => console.error("Product MetaFelids fetch Error : ", error));
    }, []);
    console.log("Product MetaField :", metaFields);
    let afterSixData = metaFields == null ? void 0 : metaFields.slice(6, metaFields.length);
    (0, import_react21.useEffect)(() => {
      const fetchData = () => __async(this, null, function* () {
        if (customerId) {
          yield fetch(`${SERVER_URL}/customer-order?customerId=${customerId}`).then((response) => response.text()).then((result) => {
            setPreviousLoading(false);
            console.log("Previous NPOS :", result);
            setPreviousData(result ? JSON.parse(result) : []);
          }).catch((error) => {
            setPreviousLoading(false);
            console.log("Error In Previous NPOS :", error);
          });
        } else {
          setPreviousLoading(false);
        }
    ...
    (0, import_react21.useEffect)(() => {
      var _a2;
      const convertedData = (previousData == null ? void 0 : previousData.npos) && ((_a2 = previousData == null ? void 0 : previousData.npos[0]) == null ? void 0 : _a2.split(",").map((item) => item.trim()));
      const filteredData = convertedData == null ? void 0 : convertedData.filter((item) => metaFields == null ? void 0 : metaFields.includes(item));
    ...
    const handleCheckboxChange = (e, val) => {
      if ((selectedNpos == null ? void 0 : selectedNpos.length) >= 5) {
      ...
      if (e) {
        ...
        setSelectedNpos((prev) => {
          return prev == null ? void 0 : prev.filter((itm) => {
            return itm !== val;
          });
        });
      }
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { toggles: "donation", onChange: () => setShowNpos(!showNpo), children: "Do Donation To NGOS" }),
      showNpo && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {}),
      previousLoading ? "" : showNpo && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { id: "donation", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 2, children: "NGO List" }),
        showNpo && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {}),
        showWarning && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "warning", children: "You can Only select Upto 5 Ngos" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {})
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Disclosure2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Grid2,
            {
              ...
              rows: ["fill", "fill"],
              spacing: "tight",
              children: (_e = metaFields == null ? void 0 : metaFields.slice(0, 6)) == null ? void 0 : _e.map((itm, idx) => {
                return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: selectedNpos == null ? void 0 : selectedNpos.includes(itm), onChange: (e) => handleCheckboxChange(e, itm), id: itm, name: itm, children: itm }, idx);
              })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "tight" }),
          showMore ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            (metaFields == null ? void 0 : metaFields.length) > 6 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { kind: "plain", toggles: "npo", onPress: () => {
              setShowMore(!showMore);
            }, children: showMore ? "Show More " : "Show Less " }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ScrollView2, { maxBlockSize: 150, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { id: "npo", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Grid2,
              {
                columns: [".42fr", ".35fr", ".3fr"],
                rows: ["fill", "fill"],
                spacing: "tight",
                children: afterSixData == null ? void 0 : afterSixData.map((itm, idx) => {
                  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: selectedNpos == null ? void 0 : selectedNpos.includes(itm), onChange: (e) => handleCheckboxChange(e, itm), children: itm });
                })
              }
            ) }) })
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ScrollView2, { maxBlockSize: 150, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { id: "npo", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Grid2,
              {
                ...
                rows: ["fill", "fill"],
                spacing: "tight",
                children: (_f = metaFields == null ? void 0 : metaFields.slice(6, metaFields.length)) == null ? void 0 : _f.map((itm, idx) => {
                  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: selectedNpos == null ? void 0 : selectedNpos.includes(itm), onChange: (e) => handleCheckboxChange(e, itm), id: itm, name: itm, children: itm }, idx);
                })
              }
            ) }) }),
            (metaFields == null ? void 0 : metaFields.length) > 6 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {}),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button2, { kind: "plain", toggles: "npo", onPress: () => {
                setShowMore(!showMore);
              }, children: showMore ? "Show More " : "Show Less " }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, {})
            ] })
