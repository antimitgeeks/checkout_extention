...
${errorInfo.componentStack}`);
  ...
  var customerId = "8255250039067";
  var SERVER_URL = "https://hang-parameters-ata-modem.trycloudflare.com";
  function Extension() {
    var _a, _b;
    const { query } = useApi();
    const [showMore, setShowMore] = (0, import_react20.useState)(true);
    const [selectedNpos, setSelectedNpos] = (0, import_react20.useState)([]);
    const [apiData, setApiData] = (0, import_react20.useState)(null);
    const [showWarning, setShowWarning] = (0, import_react20.useState)(false);
    const [showNpo, setShowNpos] = (0, import_react20.useState)(false);
    const [previousData, setPreviousData] = (0, import_react20.useState)([]);
    const [previousLoading, setPreviousLoading] = (0, import_react20.useState)(true);
    const [metaFields, setMetaFields] = (0, import_react20.useState)();
    ...
    (0, import_react20.useEffect)(() => {
      query(
        ...
        if (metaFieldsDetails) {
          const filedArray = metaFieldsDetails.filter((metaFieldsDetail) => metaFieldsDetail == null ? void 0 : metaFieldsDetail.value).flatMap((metaFieldsDetail) => metaFieldsDetail.value.split(",").map((item) => item.trim()));
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Disclosure2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Grid2,
            {
              ...
              rows: ["fill", "fill"],
              spacing: "tight",
              children: (_a = metaFields == null ? void 0 : metaFields.slice(0, 6)) == null ? void 0 : _a.map((itm, idx) => {
          ...
          showMore ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ScrollView2, { maxBlockSize: 150, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { id: "npo", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              Grid2,
              {
                ...
                rows: ["fill", "fill"],
                spacing: "tight",
                children: (_b = metaFields == null ? void 0 : metaFields.slice(6, metaFields.length)) == null ? void 0 : _b.map((itm, idx) => {
                  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: selectedNpos == null ? void 0 : selectedNpos.includes(itm), onChange: (e) => handleCheckboxChange(e, itm), id: itm, name: itm, children: itm }, idx);
                })
              }
            ) }) }),
